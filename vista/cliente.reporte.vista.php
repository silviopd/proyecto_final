        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1 class="text-bold text-black" style="font-size: 20px;">Reporte de clientes</h1>
                </section>

                <section class="content">
                    <form action="../controlador/cliente.reporte.controlador.php" method="post" target="_blank">
                        <div class="row">
<!--                            <div class="col-xs-3">
...
<!--	<script src="js/cargar-combos.js" type="text/javascript"></script>-->
        <script src="js/clientes-reporte.js" type="text/javascript"></script>
